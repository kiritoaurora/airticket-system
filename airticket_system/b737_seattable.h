#ifndef B737_SEATTABLE_H
#define B737_SEATTABLE_H

#include <QDialog>

namespace Ui {
class B737_seatTable;
}

class B737_seatTable : public QDialog
{
    Q_OBJECT

public:
    explicit B737_seatTable(QWidget *parent = nullptr);
    ~B737_seatTable();
...
private:
    Ui::B737_seatTable *ui;
    int seat_table[3][5]={};
};

#endif // B737_SEATTABLE_H
