#ifndef A330_SEATTABLE_2_H
#define A330_SEATTABLE_2_H

#include <QDialog>

namespace Ui {
class A330_seatTable_2;
}

class A330_seatTable_2 : public QDialog
{
    Q_OBJECT

public:
    explicit A330_seatTable_2(QWidget *parent = nullptr);
    ~A330_seatTable_2();
...
private:
    Ui::A330_seatTable_2 *ui;
    int seat_table[26][10]={};
};

#endif // A330_SEATTABLE_2_H
