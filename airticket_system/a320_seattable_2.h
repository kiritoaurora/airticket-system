#ifndef A320_SEATTABLE_2_H
#define A320_SEATTABLE_2_H

#include <QDialog>

namespace Ui {
class A320_seatTable_2;
}

class A320_seatTable_2 : public QDialog
{
    Q_OBJECT

public:
    explicit A320_seatTable_2(QWidget *parent = nullptr);
    ~A320_seatTable_2();
...
private:
    Ui::A320_seatTable_2 *ui;
    int seat_table[25][7]={};
};

#endif // A320_SEATTABLE_2_H
