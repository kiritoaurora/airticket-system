#ifndef A330_SEATTABLE_H
#define A330_SEATTABLE_H

#include <QDialog>

namespace Ui {
class A330_seatTable;
}

class A330_seatTable : public QDialog
{
    Q_OBJECT

public:
    explicit A330_seatTable(QWidget *parent = nullptr);
    ~A330_seatTable();
...
private:
    Ui::A330_seatTable *ui;
    int seat_table[5][8]={};
};

#endif // A330_SEATTABLE_H
